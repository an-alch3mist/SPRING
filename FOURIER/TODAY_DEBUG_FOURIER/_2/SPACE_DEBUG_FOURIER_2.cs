	...
	*/
	...
	public class OBJ
	{
		...
		public static void INITIALIZE_HOLDER()
		{
			...
			if (GameObject.Find("__OBJ_holder") != null)
			{
				GameObject.Destroy(GameObject.Find("__OBJ_holder"));
			}

			holder = new GameObject("__OBJ_holder").transform;
		}
	...
	public class OBJS
	{
		...
		public static void INITIALIZE_HOLDER()
		{
			if (GameObject.Find("__OBJS_holder") != null)
				GameObject.Destroy(GameObject.Find("__OBJS_holder"));

			holder = new GameObject("__OBJS_holder").transform;
		}
	...
	public class TEXT
	{
		#region INITIALIZE_HOLDER
		public static Transform holder;
		public static void INITIALIZE_HOLDER()
		{
			if (GameObject.Find("__TEXT_holder") != null)
			{
				GameObject.Destroy(GameObject.Find("__TEXT_holder"));
			}
			TEXT.holder = new GameObject("__TEXT_holder").transform;
		...
		public TEXT(string str)
		{
			...
			G.transform.parent = TEXT.holder;
			G.SetActive(false);
		}
		...
		public void orient( int i_pivot, int i_anchor , Vector2 pos_pivot, Vector2 pos_anchor )
		{
			...
			DRAW.col = Color.HSVToRGB(0f, 0.3f, 0.9f);

			DRAW.QUAD(G.transform.position, G.transform.localScale.x, G.transform.localScale.y);
			//
		...
		public IEnumerator animate_typewrite()
		{
			//
			G.SetActive(true);
